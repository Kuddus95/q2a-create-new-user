...
qa_register_plugin_module('page', 'q2a-create-new-user-page.php', 'q2a_create_new_user', 'Create New User Page');

// page to create many users at once 
qa_register_plugin_module('page', 'q2a-create-new-users-batch-page.php', 'q2a_create_new_users_batch', 'Create New Users Batch Page');


function q2a_get_userid_by_email($usermail)
{
...
function q2a_generate_userhandle($name)
{ 
...
function q2a_finduserhandle($inhandle)
{ 
	return qa_db_read_one_value(
						qa_db_query_sub(
...
function q2a_create_new_user($email, $password, $handle, $level=QA_USER_LEVEL_BASIC, $confirmed=false)
{
	...
	// q2a extra: set flag for no newsletter
